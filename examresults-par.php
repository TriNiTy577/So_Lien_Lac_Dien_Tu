                        ...
                        <div class="x_panel">
                          ...
                          if ($result->num_rows > 0) {
                            ...
                            while ($row = $result->fetch_assoc()) {
                              echo "<tr><td> " . $row["sid"] . " </td><td> " . $row["fname"] . " " . $row["lname"] . " </td><td><a href='examresults-stu-view.php?sid=" . $row["sid"] . "'><small class='btn btn-sm btn-success'>View Results</small></a></td></tr>";
                            }
                          }
