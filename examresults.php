      ...
      <div class="right_col" role="main">
        <div class="row">
          <div class="col-md-3">
            <div class="x_panel">
              <div class="x_title">
                <h2><?php echo (isset($_GET['update'])) ? "Update examresult" : "Add examresult"; ?>
                </h2>
                  ...
                  <div class="box-body">
                    ...
                    <div class="form-group">
                      ...
                      <select class="form-control select2 select2-hidden-accessible"
                        style="width: 100%;" tabindex="-1" aria-hidden="true" name="exam">
                        <option>Select Exam</option>
                        <?php
                        $sql = "SELECT e.*, sub.title as subject_name 
                                FROM exam e 
                    ...
                    <div class="form-group">
                      <label>Student</label>
                      <select class="form-control select2 select2-hidden-accessible"
                        style="width: 100%;" tabindex="-1" aria-hidden="true" name="student">
                    ...
                    <div class="form-group">
                      ...
                      <input name="marks" type="number" class="form-control"
                        id="exampleInputPassword1" placeholder="Enter Marks" required>
                    </div>

                    <div class="form-group" hidden>
                      <label>Grade </label>
                      <select class="form-control select2 select2-hidden-accessible"
                        style="width: 100%;" tabindex="-1" aria-hidden="true" name="grade">
