...
$contact = $skill = $email = $tid = $fname = $lname = $classroom = $dob = $gender = $address = $parent = " ";
                ...
                <form role="form" method="POST">
                  <div class="box-body">
                    ...
                    <div class="form-group">
                      ...
                      <div class="input-group date">
                        <input type="date" name='dob' class="form-control pull-right"
                          id="datepicker" value=<?php echo "'" . $dob . "'"; ?>>
                      </div>
                      <!-- /.input group -->
                    ...
                    <div class="form-group">
                      ...
                      <textarea name="skill" class="form-control" id="exampleFormControlTextarea1"
                        rows="2"><?php echo $skill; ?></textarea>
                    </div>
                  ...
                  <div class="box-footer">
                    <button type="submit" name="submit" value="submit"
                      class="btn btn-primary">Update Teacher</button>
                  </div>
                </form>
